  ...
  return (
    <div className="space-y-8 py-6">
      ...
      <div className="space-y-4">
        <Label className="text-lg font-medium">What did you do today?</Label>
      ...
      {/* People */}
      <div className="space-y-4">
        <Label className="text-lg font-medium">Who were you with?</Label>
        <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-7 gap-3">
      ...
      {/* Weather */}
      <div className="space-y-4">
        <Label className="text-lg font-medium">Weather?</Label>
