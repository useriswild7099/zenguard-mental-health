    ...
    <div className="space-y-8 py-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-xs text-muted-foreground px-1">
            <span>Low</span>
            <span className="font-medium text-foreground">{pulse.mood}/10</span>
            <span>High</span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-xs text-muted-foreground px-1">
            <span>Drained</span>
            <span className="font-medium text-foreground">{pulse.energy}/10</span>
            <span>Energized</span>
          </div>
        </div>
      </div>
      ...
      {(pulse.mood > 0 && pulse.energy > 0) && (
        <div className="mt-6 p-4 bg-white/60 dark:bg-gray-800/40 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-white/10 shadow-lg">
