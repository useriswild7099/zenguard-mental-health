...
export default function SafetySection({ onNavigate }: SafetySectionProps) {
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-rose-500/5 border-t border-rose-500/10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="glass-card-premium p-1 border border-rose-500/20 shadow-2xl overflow-hidden">
          <div className="p-10 md:p-16 flex flex-col md:flex-row gap-12 items-center">
            
            <div className="flex-1 space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 text-xs font-black uppercase tracking-widest">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-white leading-tight uppercase tracking-tighter">
                Sia is a <span className="text-rose-500">Companion,</span> <br />
                Not a Crisis Center.
              </h2>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <button 
                  ...
                  className="px-8 py-4 bg-rose-600 hover:bg-rose-500 text-white font-bold rounded-2xl transition-all shadow-lg hover:shadow-rose-500/20 flex items-center gap-3 active:scale-95"
                >
            ...
            <div className="w-full md:w-80 space-y-4">
               ...
               <div className="mt-8 p-6 rounded-3xl bg-gradient-to-br from-rose-500/10 to-transparent border border-rose-500/5 text-center">
